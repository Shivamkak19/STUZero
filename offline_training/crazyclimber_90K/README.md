...
# STUZero CrazyClimber Dynamics Dataset

Offline dynamics training dataset collected from a trained EfficientZero
benchmark model on Atari CrazyClimber.
...
|--------|-------|
| Episodes | 50 |
| Total transitions | 171,813 |
| Mean episode length | 3436 steps |
| Mean episode reward | 100828.0 |
...
| Parameter | Value |
|-----------|-------|
| Environment | Atari CrazyClimber |
