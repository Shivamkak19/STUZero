...
# STUZero DemonAttack Dynamics Dataset

Offline dynamics training dataset collected from a trained EfficientZero
benchmark model on Atari DemonAttack.
...
|--------|-------|
| Episodes | 50 |
| Total transitions | 231,127 |
| Mean episode length | 4623 steps |
| Mean episode reward | 11341.4 |
